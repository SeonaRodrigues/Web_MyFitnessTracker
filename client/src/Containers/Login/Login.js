												...
												<div className='right-inner'>
														<form onSubmit={this.handleSubmit.bind(this)}>
																...
																<div className="username-container">
																		<label><strong>Username</strong></label><br></br><br></br>
																		<input type="text" name="username" className="form-input" placeholder="" onChange={this.handleChange.bind(this)}/>
																		{this.state.usernameError && <p>{this.state.usernameError}</p>}
																</div><br></br>
																<div className="password-container">
																		<label><strong>Password</strong></label><br></br>
																		<input type="password" name="password" className="form-input" placeholder="" onChange={this.handleChange.bind(this)}/>
